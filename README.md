...
- **placement.c** : This file is used to perform data placement between Dram and Optane based on the profiling and placement results of our algorithm. It reads the output.txt file
  ...
  memory type, starting with optane. For example, if the first three lines are [1000, 2000, 3000] this means that the algorithm must place the first 1 kB to optane, the next 2 kB after that to Dram,
